    ...
    value: function markPaymentPaid(id, servicePaymentDetail) {
      ...
      return _bluebird2.default.try(function() {
        return _bluebird2.default.all([
          _this10.modals.calendar_item_payment.create(servicePaymentDetail),
          _this10.retrieveCalendarItemById(id, 'en')]);
      }).then(function(result) {
        ...
        return _bluebird2.default.all([
          ...
          provider_name && provider_name.trim() ?
              _this10.sellerAdaptor.retrieveOrCreateOfflineSellers(sellerOption,
                  {

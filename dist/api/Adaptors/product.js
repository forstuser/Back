  ...
  _createClass(ProductAdaptor, [{
    ...
    value: function retrieveProducts(options) {
      ...
      return this.modals.products.findAll({
        ...
        products = productResult.map(function (item) {
          ...
          productItem.cImageURL = productItem.sub_category_id ? '/categories/' + productItem.sub_category_id + '/images/' : productItem.cImageURL;
    ...
    value: function retrieveProductIds(options) {
      ...
      return this.modals.products.findAll({
        ...
        return productResult.map(function (item) {
          ...
          return productItem.status_type !== 8 || productItem.status_type === 8 && productItem.bill && productItem.bill.status_type === 5;
        });
      });
    }
  }, {
    ...
    value: function retrieveProductCounts(options) {
      ...
      return this.modals.products.findAll({
        ...
        var availableResult = [].concat(_toConsumableArray(results[0]), _toConsumableArray(results[1]), _toConsumableArray(results[2]), _toConsumableArray(results[3]), _toConsumableArray(results[4]));
    ...
    value: function retrieveProductById(id, options) {
      ...
      return this.modals.products.findOne({
        ...
        if (products) {
          ...
          var serviceSchedulePromise = products.schedule ? _this4.serviceScheduleAdaptor.retrieveServiceSchedules({
        ...
        if (products) {
          ...
          products.serviceSchedules = results[7] ? results[7].map(function (scheduleItem) {
        ...
        if (productResult) {
          ...
          if (otherItems.warranty) {
            ...
            if (otherItems.warranty.renewal_type) {
              ...
              var effective_date = _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.warranty.effective_date, 'DD MMM YY').startOf('day');
            ...
            if (otherItems.warranty.dual_renewal_type) {
              ...
              var _effective_date = _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.warranty.effective_date, 'DD MMM YY').startOf('day');
              expiry_date = _moment2.default.utc(_effective_date, _moment2.default.ISO_8601).add(warrantyRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
              warrantyItemPromise.push(_this5.warrantyAdaptor.createWarranties({
                ...
                product_id: product.id,
                expiry_date: _moment2.default.utc(expiry_date).format('YYYY-MM-DD'),
                effective_date: _moment2.default.utc(_effective_date).format('YYYY-MM-DD'),
                document_date: _moment2.default.utc(_effective_date).format('YYYY-MM-DD'),
                warranty_type: 3,
                user_id: productBody.user_id
              }));
            }
            ...
            if (otherItems.warranty.extended_renewal_type) {
              ...
              var _effective_date2 = _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.warranty.effective_date, 'DD MMM YY').startOf('day');
              expiry_date = _moment2.default.utc(_effective_date2).add(warrantyRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
              warrantyItemPromise.push(_this5.warrantyAdaptor.createWarranties({
                ...
                product_id: product.id,
                expiry_date: _moment2.default.utc(expiry_date).format('YYYY-MM-DD'),
                effective_date: _moment2.default.utc(_effective_date2).format('YYYY-MM-DD'),
                document_date: _moment2.default.utc(_effective_date2).format('YYYY-MM-DD'),
                warranty_type: 2,
                user_id: productBody.user_id
              }));
            }
            ...
            if (otherItems.warranty.accessory_renewal_type) {
              ...
              var _effective_date3 = _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.warranty.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.warranty.effective_date, 'DD MMM YY').startOf('day');
              expiry_date = _moment2.default.utc(_effective_date3).add(warrantyRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
              warrantyItemPromise.push(_this5.warrantyAdaptor.createWarranties({
                ...
                product_id: product.id,
                expiry_date: _moment2.default.utc(expiry_date).format('YYYY-MM-DD'),
                effective_date: _moment2.default.utc(_effective_date3).format('YYYY-MM-DD'),
                document_date: _moment2.default.utc(_effective_date3).format('YYYY-MM-DD'),
                warranty_type: 4,
                user_id: productBody.user_id
              }));
            }
          ...
          if (otherItems.insurance) {
            var _effective_date4 = _moment2.default.utc(otherItems.insurance.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.insurance.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.insurance.effective_date, 'DD MMM YY').startOf('day');
            var _expiry_date = _moment2.default.utc(_effective_date4, _moment2.default.ISO_8601).add(8759, 'hours').endOf('days');
            insurancePromise.push(_this5.insuranceAdaptor.createInsurances({
              renewal_type: 8,
              updated_by: productBody.user_id,
              status_type: 11,
              product_id: product.id,
              expiry_date: _moment2.default.utc(_expiry_date).format('YYYY-MM-DD'),
              effective_date: _moment2.default.utc(_effective_date4).format('YYYY-MM-DD'),
              document_date: _moment2.default.utc(_effective_date4).format('YYYY-MM-DD'),
          ...
          if (otherItems.amc) {
            ...
            var _effective_date5 = _moment2.default.utc(otherItems.amc.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.amc.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.amc.effective_date, 'DD MMM YY').startOf('day');
            var _expiry_date2 = _moment2.default.utc(_effective_date5, _moment2.default.ISO_8601).add(amcRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days').format('YYYY-MM-DD');
            amcPromise.push(_this5.amcAdaptor.createAMCs({
              renewal_type: 8,
              updated_by: productBody.user_id,
              status_type: 11,
              product_id: product.id,
              expiry_date: _moment2.default.utc(_expiry_date2).format('YYYY-MM-DD'),
              effective_date: _moment2.default.utc(_effective_date5).format('YYYY-MM-DD'),
              document_date: _moment2.default.utc(_effective_date5).format('YYYY-MM-DD'),
              user_id: productBody.user_id
            }));
          }
          ...
          if (otherItems.puc) {
            ...
            var _effective_date6 = _moment2.default.utc(otherItems.puc.effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(otherItems.puc.effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(otherItems.puc.effective_date, 'DD MMM YY').startOf('day');
            var _expiry_date3 = _moment2.default.utc(_effective_date6, _moment2.default.ISO_8601).add(pucRenewalType, 'months').subtract(1, 'day').endOf('days').format('YYYY-MM-DD');
            pucPromise.push(otherItems.puc.id ? _this5.pucAdaptor.updatePUCs(otherItems.puc.id, {
              ...
              expiry_date: _moment2.default.utc(_expiry_date3).format('YYYY-MM-DD'),
              effective_date: _moment2.default.utc(_effective_date6).format('YYYY-MM-DD'),
              document_date: _moment2.default.utc(_effective_date6).format('YYYY-MM-DD'),
              user_id: productBody.user_id
    ...
    value: function updateProductDetails(productBody, metadataBody, otherItems, productId) {
      ...
      return Promise.all([productBody.brand_id ? this.modals.products.count({
        ...
        var isAMCRepairSellerSame = otherItems.repair && otherItems.amc && otherItems.repair.seller_contact === otherItems.amc.seller_contact;
        var isProductPUCSellerSame = false;
        var insuranceProviderPromise = otherItems.insurance && otherItems.insurance.provider_name ? _this6.insuranceAdaptor.findCreateInsuranceBrand({
        ...
        var warrantyProviderPromise = otherItems.warranty && otherItems.warranty.extended_provider_name ? _this6.insuranceAdaptor.findCreateInsuranceBrand({
          main_category_id: productBody.main_category_id,
          category_id: productBody.category_id,
          type: 2,
          status_type: 11,
        ...
        return Promise.all(sellerPromise).then(function (newItemResults) {
          ...
          product.brand_id = sellerList[5] ? sellerList[5].brand_id : product.brand_id;
          metadata = metadataBody.map(function (mdItem) {
            mdItem = _lodash2.default.omit(mdItem, 'new_drop_down');
            return mdItem;
          });
          ...
          product = !product.colour_id ? _lodash2.default.omit(product, 'colour_id') : product;
          product = !product.purchase_cost && product.purchase_cost !== 0 ? _lodash2.default.omit(product, 'purchase_cost') : product;
          product = _lodash2.default.omit(product, 'new_drop_down');
          product = !product.model && product.model !== '' ? _lodash2.default.omit(product, 'model') : product;
          product = !product.taxes && product.taxes !== 0 ? _lodash2.default.omit(product, 'taxes') : product;
          product = !product.document_number ? _lodash2.default.omit(product, 'document_number') : product;
          product = !product.document_date ? _lodash2.default.omit(product, 'document_date') : product;
          product = !product.seller_id ? _lodash2.default.omit(product, 'seller_id') : product;
          ...
          }), _this6.modals.categories.findOne({
            where: {
              category_id: product.category_id
            }
          })] : [, _this6.modals.categories.findOne({
          ...
          brandModelPromise.push(_this6.modals.warranties.findAll({
            where: {
              product_id: productId,
              warranty_type: 1
            },
            order: [['expiry_date', 'ASC']]
          }), _this6.modals.warranties.findAll({
            where: {
              product_id: productId,
              warranty_type: 3
            },
            order: [['expiry_date', 'ASC']]
          }), _this6.modals.metaData.findAll({
            where: {
              product_id: productId
            }
          }));
          ...
          if (product) {
            ...
            if (product.main_category_id === 3 && product.model) {
              var diffDays = _moment2.default.utc().diff(_moment2.default.utc(product.document_date), 'days', true);
              var diffMonths = _moment2.default.utc().diff(_moment2.default.utc(product.document_date), 'months', true);
            ...
            var productModel = updateProductResult[2];
            var productCategory = updateProductResult[3];
            var normalWarranties = updateProductResult[4] ? updateProductResult[4].map(function (item) {
              return item.toJSON();
            }) : [];
            var dualWarranties = updateProductResult[5] ? updateProductResult[5].map(function (item) {
              return item.toJSON();
            }) : [];

            var currentMetaData = updateProductResult[6] ? updateProductResult[6].map(function (item) {
              return item.toJSON();
            }) : [];
            if (!product.isModalSame) {
              if (productCategory) {
                if (productCategory.type_category_form) {
                  var typeMDExist = metadata.find(function (mdItem) {
                    return mdItem.category_form_id === productCategory.type_category_form;
                  });
                  if (!typeMDExist || !product.model) {
                    metadata.push({
                      category_form_id: productCategory.type_category_form,
                      form_value: productModel ? productModel.product_type : null,
                ...
                if (productCategory.category_form_1) {
                  var _typeMDExist = metadata.find(function (mdItem) {
                    return mdItem.category_form_id === productCategory.category_form_1;
                  });
                  if (!_typeMDExist || !product.model) {
                    metadata.push({
                      category_form_id: productCategory.category_form_1,
                      form_value: productModel ? productModel.category_form_1_value : null,
                      updated_by: product.user_id
                    });
                  }
                }
                ...
                if (productCategory.category_form_2) {
                  var _typeMDExist2 = metadata.find(function (mdItem) {
                    return mdItem.category_form_id === productCategory.category_form_2;
                  });
                  if (!_typeMDExist2 || !product.model) {
                    metadata.push({
                      category_form_id: productCategory.category_form_2,
                      form_value: productModel ? productModel.category_form_2_value : null,
                      updated_by: product.user_id
                    });
                  }
                }
              ...
              if (!otherItems.warranty) {
                if ((productModel || !product.model) && normalWarranties.length > 0) {
                  warrantyItemPromise.push.apply(warrantyItemPromise, _toConsumableArray(normalWarranties.map(function (wItem) {
                    return _this6.warrantyAdaptor.deleteWarranties(wItem.id, product.user_id);
                  })));
                }

                if ((productModel || !product.model) && dualWarranties.length > 0) {
                  warrantyItemPromise.push.apply(warrantyItemPromise, _toConsumableArray(dualWarranties.map(function (wItem) {
                    return _this6.warrantyAdaptor.deleteWarranties(wItem.id, product.user_id);
                  })));
                }

                otherItems.warranty = {
                  renewal_type: productModel ? productModel.warranty_renewal_type : undefined,
                  dual_renewal_type: productModel ? productModel.dual_renewal_type : undefined
                };
              }
            }
            ...
            var metadataPromise = metadata.filter(function (mdItem) {
              return mdItem.category_form_id;
            }).map(function (mdItem) {
              mdItem.status_type = 11;
              var currentMetaDataItem = currentMetaData.find(function (cmdItem) {
                return cmdItem.category_form_id === mdItem.category_form_id;
              });
              if (currentMetaDataItem && currentMetaDataItem.id) {
                return _this6.updateProductMetaData(currentMetaDataItem.id, mdItem);
              }
          ...
          if (productItemsResult) {
            ...
            product.metaData = productItemsResult[0] && productItemsResult[0].length > 0 ? productItemsResult[0].map(function (mdItem) {
              return mdItem.toJSON();
            }) : [];
            product.insurances = productItemsResult[1];
            product.warranties = productItemsResult[2];
            ...
            if (productItemsResult[6] && productItemsResult[6].length > 0) {
              productPromise.push(_this6.updateProduct(product.id, {
            ...
            } else if (productItemsResult[6] && productItemsResult[6].length === 0) {
              productPromise.push(_this6.updateProduct(product.id, {
                service_schedule_id: null
              }));
            }
            product.serviceCenterUrl = productItemsResult[7] && productItemsResult[7] > 0 ? '/consumer/servicecenters?brandid=' + product.brand_id + '&categoryid=' + product.category_id : '';
            return product;
          }
          ...
          return console.log('Error on update product detail ' + new Date() + ' for user ' + product.user_id + ' is as follow: \n \n ' + err);
        });
      });
    }
  }, {
    ...
    value: function preparePUCPromise(parameters) {
      ...
      var effective_date = otherItems.puc.effective_date || productBody.document_date;
      ...
      var expiry_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).add(otherItems.puc.expiry_period || 6, 'months').subtract(1, 'day').endOf('days').format('YYYY-MM-DD');
      var values = {
      ...
      pucPromise.push(otherItems.puc.id ? this.pucAdaptor.updatePUCs(otherItems.puc.id, values) : this.pucAdaptor.createPUCs(values));
    }
  }, {
    ...
    value: function prepareRepairPromise(parameters) {
      ...
      var document_date = otherItems.repair.document_date || productBody.document_date;
      ...
      var repairSellerId = isProductRepairSellerSame ? sellerList[0].sid : isAMCRepairSellerSame ? sellerList[1].sid : otherItems.repair.seller_name || otherItems.repair.seller_contact ? sellerList[2].sid : undefined;
      var values = {
        updated_by: productBody.user_id,
        status_type: 11,
        product_id: productId,
      ...
      repairPromise.push(otherItems.repair.id ? this.repairAdaptor.updateRepairs(otherItems.repair.id, values) : this.repairAdaptor.createRepairs(values));
    }
  }, {
    ...
    value: function prepareAMCPromise(parameters) {
      ...
      var effective_date = otherItems.amc.effective_date || productBody.document_date;
      effective_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(effective_date, 'DD MMM YY').startOf('day');
      ...
      amcPromise.push(otherItems.amc.id ? this.amcAdaptor.updateAMCs(otherItems.amc.id, values) : this.amcAdaptor.createAMCs(values));
    }
  }, {
    ...
    value: function prepareInsurancePromise(parameters) {
      ...
      var effective_date = otherItems.insurance.effective_date || productBody.document_date;
      effective_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(effective_date, 'DD MMM YY').startOf('day');
      var expiry_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).add(insuranceRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
      var values = {
        ...
        document_date: _moment2.default.utc(effective_date).format('YYYY-MM-DD'),
        document_number: otherItems.insurance.policy_no,
        provider_id: otherItems.insurance.provider_name && sellerList[4] ? sellerList[4].id : otherItems.insurance.provider_id,
        amount_insured: otherItems.insurance.amount_insured,
        renewal_cost: otherItems.insurance.value,
        user_id: productBody.user_id
      };
      insurancePromise.push(otherItems.insurance.id ? this.insuranceAdaptor.updateInsurances(otherItems.insurance.id, values) : this.insuranceAdaptor.createInsurances(values));
    }
  }, {
    ...
    value: function prepareWarrantyPromise(parameters) {
      ...
      if (otherItems.warranty.id && !otherItems.warranty.renewal_type) {
        warrantyItemPromise.push(this.warrantyAdaptor.updateWarranties(otherItems.warranty.id, { status_type: 11 }));
      }

      if (otherItems.warranty.extended_id && !otherItems.warranty.extended_renewal_type) {
      ...
      if (otherItems.warranty.renewal_type) {
        ...
        var effective_date = otherItems.warranty.effective_date || productBody.document_date;
        effective_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(effective_date, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(effective_date, 'DD MMM YY').startOf('day');
        expiry_date = _moment2.default.utc(effective_date, _moment2.default.ISO_8601).add(warrantyRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
      ...
      if (otherItems.warranty.extended_renewal_type) {
        ...
        var _effective_date7 = otherItems.warranty.extended_effective_date || expiry_date || productBody.document_date;
        _effective_date7 = _moment2.default.utc(_effective_date7, _moment2.default.ISO_8601).isValid() ? _moment2.default.utc(_effective_date7, _moment2.default.ISO_8601).startOf('day') : _moment2.default.utc(_effective_date7, 'DD MMM YY').startOf('day');
        expiry_date = _moment2.default.utc(_effective_date7).add(warrantyRenewalType.effective_months, 'months').subtract(1, 'day').endOf('days');
        warrantyItemPromise.push(otherItems.warranty.extended_id ? this.warrantyAdaptor.updateWarranties(otherItems.warranty.extended_id, {
          renewal_type: otherItems.warranty.extended_renewal_type,
          provider_id: otherItems.warranty.extended_provider_name && sellerList[4] ? sellerList[6].id : otherItems.warranty.extended_provider_id,
          updated_by: productBody.user_id,
          status_type: 11,
          job_id: productBody.job_id,
          product_id: productId,
          expiry_date: _moment2.default.utc(expiry_date).format('YYYY-MM-DD'),
          effective_date: _moment2.default.utc(_effective_date7).format('YYYY-MM-DD'),
          document_date: _moment2.default.utc(_effective_date7).format('YYYY-MM-DD'),
          warranty_type: 2,
          user_id: productBody.user_id
        }) : this.warrantyAdaptor.createWarranties({
          renewal_type: otherItems.warranty.extended_renewal_type,
      ...
      warrantyItemPromise.push(this.warrantyAdaptor.updateWarrantyPeriod({ product_id: productId, user_id: productBody.user_id }, productBody.document_date, productBody.document_date));
    }
  }, {
    ...
    value: function retrieveProductMetadata(options) {
      ...
      return this.modals.metaData.findAll({
        ...
        attributes: ['id', ['product_id', 'productId'], ['form_value', 'value'], ['category_form_id', 'categoryFormId'], [this.modals.sequelize.literal('"categoryForm"."form_type"'), 'formType'], [this.modals.sequelize.literal('"categoryForm"."title"'), 'name'], [this.modals.sequelize.literal('"categoryForm"."display_index"'), 'displayIndex']]
    ...
    value: function updateProduct(id, productDetail) {
      ...
      return this.modals.products.findOne({
        ...
        console.log('\n\n\n', JSON.stringify({ productDetail: productDetail }));
        var isModalSame = itemDetail.model === productDetail.model;
    ...
    value: function deleteProduct(id, userId) {
      ...
      return this.modals.products.findById(id).then(function (result) {
        if (result) {
          var jobPromise = result.job_id ? [_this11.modals.jobs.update({
            user_status: 3,
            admin_status: 3,
            ce_status: null,
            qe_status: null,

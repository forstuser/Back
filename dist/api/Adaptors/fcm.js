...
class FCMManager {
  ...
  async findOrUpdateFCMDetails(where, defaults, selected_language) {
    ...
    fcm_details = fcm_details ? fcm_details.toJSON() : undefined;
    defaults.selected_language = selected_language ? selected_language : fcm_details ? fcm_details.selected_language : 'en';
    if (fcm_details) {

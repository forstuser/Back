          ...
          return _this.retrieveProducts({
            ...
            then(function(products) {
              ...
              return _bluebird2.default.all([
                _this.retrieveAccessoryCategories({
            ...
            spread(function(accessoryCategories, categoryNames) {
              ...
              return _bluebird2.default.all([
                accessoryCategories, _this.retrieveAccessoryProducts({
                  where: productOptions,
                }), categoryNames]);
            }).
            spread(function(accessoryCategories, accessoryProducts,
                            categoryNames) {
        ...
        return _bluebird2.default.try(function() {
          return _this2.retrieveTransactions({
            ...
            then(function(transactions) {
              var accessory_product_ids = transactions.map(
            ...
            spread(function(accessoryProducts, products, paymentModes,
                            transactions) {

  ...
  static async retrieveCalendarServices(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        const [items, unit_types] = await calendarServiceAdaptor.retrieveCalendarServices({ status_type: 1 }, request.language);
        return reply.response({
          status: true,
          items,
          unit_types,
  ...
  static async updateItem(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        await calendarServiceAdaptor.updateCalendarItem(productBody, request.params.id);
        return reply.response({
          status: true,
          message: 'successful',
          forceUpdate: request.pre.forceUpdate
  ...
  static async markAbsent(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        const [calcResults, absentDetail] = await _bluebird2.default.all([calendarServiceAdaptor.retrieveCurrentCalculationDetail({
        ...
        const payment_detail = await calendarServiceAdaptor.updatePaymentDetail(request.params.id, {
  ...
  static async markPaid(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        const payment_detail = await calendarServiceAdaptor.markPaymentPaid(request.params.id, servicePaymentDetail);
        return reply.response({
          status: true,
          message: 'successful',
          payment_detail,
  ...
  static async markPresent(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        const [calcResults, presentDetail] = await _bluebird2.default.all([calendarServiceAdaptor.retrieveCurrentCalculationDetail({
          ref_id: request.params.ref_id, effective_date: {
  ...
  static async retrieveCalendarItem(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        const result = await calendarServiceAdaptor.retrieveCalendarItemById(request.params.id, request.language);
        return reply.response({
          status: true,
          message: 'successful',
          item: result,
  ...
  static async deleteCalendarItem(request, reply) {
    ...
    try {
      if (request.pre.userExist === 0) {
        ...
        await calendarServiceAdaptor.deleteCalendarItemById(request.params.id, user.id || user.ID);
        return reply.response({
          status: true,
          message: 'successful',
          forceUpdate: request.pre.forceUpdate

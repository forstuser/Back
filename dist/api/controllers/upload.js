...
var categoryImageType = ['xxhdpi-small', 'xxhdpi'];
...
var UploadController = function () {
  ...
  _createClass(UploadController, null, [{
    ...
    value: function uploadArrayOfFile(parameters) {
      ...
      return _bluebird2.default.all(fileUploadPromises).then(function (fileResult) {
        var promisedQuery = [];
    ...
    value: function retrieveCategoryImage(request, reply) {
      if (!request.pre.forceUpdate) {
        var fsImplCategory = new _s3fs2.default(_main2.default.AWS.S3.BUCKET + '/' + _main2.default.AWS.S3.CATEGORY_IMAGE + '/' + categoryImageType[request.params.type || 0] + (request.params.file_type ? '/' + request.params.file_type : ''), _main2.default.AWS.ACCESS_DETAILS);
    ...
    value: function retrieveProductImage(request, reply) {
      if (!request.pre.forceUpdate) {
        var fsImplProduct = new _s3fs2.default(_main2.default.AWS.S3.BUCKET + '/' + _main2.default.AWS.S3.PRODUCT_IMAGE + (request.params.file_type ? '/' + request.params.file_type : ''), _main2.default.AWS.ACCESS_DETAILS);
        return modals.products.findOne({
          where: {
            id: request.params.id
          }

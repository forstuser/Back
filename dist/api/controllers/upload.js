...
var fsImpl = new _s3fs2.default(_main2.default.AWS.S3.BUCKET,
  ...
  _createClass(UploadController, null, [
    {
      ...
      value: function deleteFile(request, reply) {
        ...
        if (!user) {
          ...
          if (!request.pre.forceUpdate) {
            Promise.all([
              modals.jobs.findById(request.params.id), modals.jobCopies.update({
                status_type: 3,
                updated_by: user.id || user.ID,
              }, {
                where: {
      ...
      value: function retrieveBrandImage(request, reply) {
        if (!request.pre.forceUpdate) {
          var fsImplBrand = new _s3fs2.default(_main2.default.AWS.S3.BUCKET +
              '/' + _main2.default.AWS.S3.BRAND_IMAGE,
              _main2.default.AWS.ACCESS_DETAILS);

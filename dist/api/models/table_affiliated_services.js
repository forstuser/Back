...
exports.default = function (sequelize, DataTypes) {
    var table_affiliated_services = sequelize.define('table_affiliated_services', {
        name: {
    ...
    table_affiliated_services.associate = function (models) {
        ...
        table_affiliated_services.belongsTo(models.statuses, { foreignKey: 'status_type', targetKey: 'status_type', onDelete: 'cascade', onUpdate: 'cascade' });
    };

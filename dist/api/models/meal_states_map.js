...
exports.default = function (sequelize, DataTypes) {
  ...
  mealStateMap.associate = function (models) {
    ...
    mealStateMap.belongsTo(models.meals, { foreignKey: 'meal_id', onDelete: 'cascade', onUpdate: 'cascade' });
    mealStateMap.belongsTo(models.states, { foreignKey: 'state_id', onDelete: 'cascade', onUpdate: 'cascade' });
  };
  return mealStateMap;
};
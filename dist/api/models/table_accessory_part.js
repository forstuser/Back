...
exports.default = (sequelize, DataTypes) => {
  ...
  accessory_part.associate = models => {
    ...
    accessory_part.belongsTo(models.users, { foreignKey: 'updated_by', onDelete: 'cascade', onUpdate: 'cascade' });

    accessory_part.belongsTo(models.users, { foreignKey: 'created_by', onDelete: 'cascade', onUpdate: 'cascade' });

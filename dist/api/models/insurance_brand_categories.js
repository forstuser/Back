...
exports.default = function (sequelize, DataTypes) {
  ...
  insuranceBrandCategories.associate = function (models) {
    insuranceBrandCategories.belongsTo(models.users, { foreignKey: 'updated_by' });

    insuranceBrandCategories.belongsTo(models.statuses, { foreignKey: 'status_type', targetKey: 'status_type' });

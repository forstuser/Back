  ...
  if (userController) {
    ...
    authRoutes.push({
      ...
      config: {
        ...
        validate: {
          payload: {
            phoneNo: _joi2.default.string(),
            location: [_joi2.default.string(), _joi2.default.allow(null)],
            longitude: [_joi2.default.string(), _joi2.default.allow(null)],
            latitude: [_joi2.default.string(), _joi2.default.allow(null)],
            osTypeId: [_joi2.default.string(), _joi2.default.allow(null)],
            fcmId: [_joi2.default.string(), _joi2.default.allow(null)],
            email: [_joi2.default.string(), _joi2.default.allow(null, '')],
            oldEmail: [_joi2.default.string(), _joi2.default.allow(null, '')],
            deviceId: [_joi2.default.string(), _joi2.default.allow(null)],
            deviceModel: [_joi2.default.string(), _joi2.default.allow(null)],
            apkVersion: [_joi2.default.string(), _joi2.default.allow(null)],
            name: [_joi2.default.string(), _joi2.default.allow(null, '')],
            isEnrolled: [_joi2.default.boolean(), _joi2.default.allow(null)],
            categoryId: [_joi2.default.number(), _joi2.default.allow(null)],
            isPhoneAllowed: [_joi2.default.boolean(), _joi2.default.allow(null)],
            isEmailAllowed: [_joi2.default.boolean(), _joi2.default.allow(null)],

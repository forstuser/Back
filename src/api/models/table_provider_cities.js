...
export default (sequelize, DataTypes) => {
    const table_provider_cities = sequelize.define('table_provider_cities', {
            provider_id: {
    ...
    table_provider_cities.associate = (models) => {
        ...
        table_provider_cities.belongsTo(models.table_service_providers,
            {foreignKey: 'provider_id', onDelete: 'cascade', onUpdate: 'cascade'});
        ...
        table_provider_cities.hasMany(models.table_provider_categories,
            {foreignKey: 'provider_city_id', as: 'categories', onDelete: 'cascade', onUpdate: 'cascade'});
    };

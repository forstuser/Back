...
export default (sequelize, DataTypes) => {
  ...
  seller_categories.associate = (models) => {
    seller_categories.belongsTo(models.users,
        {foreignKey: 'updated_by', onDelete: 'cascade', onUpdate: 'cascade'});
    seller_categories.belongsTo(models.sku_categories,
        {foreignKey: 'category_id', as: 'category', onDelete: 'cascade', onUpdate: 'cascade'});
    seller_categories.belongsTo(models.sku_categories,
        {foreignKey: 'main_category_id', as: 'main_category', onDelete: 'cascade', onUpdate: 'cascade'});
    seller_categories.belongsTo(models.sku_categories,
        {foreignKey: 'sub_category_id', as: 'sub_category', onDelete: 'cascade', onUpdate: 'cascade'});
    seller_categories.belongsTo(models.offlineSellers,
        {foreignKey: 'seller_id', as: 'seller', onDelete: 'cascade', onUpdate: 'cascade'});
    seller_categories.belongsTo(models.statuses,

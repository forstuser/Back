...
const sendOTPOverEmail = async (email, name, otpLength) => await Promise.try(
    async () => {
      ...
      const mailOptions = {
        ...
        subject: config.EMAIL.OTP.SUBJECT,

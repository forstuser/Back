...
class BillManagementController {
	constructor(modal) {
		...
		modals.table_cust_executive_tasks.belongsTo(modals.table_users, {
		...
		modals.table_qual_executive_tasks.hasOne(modals.table_cust_executive_tasks, {
			foreignKey: 'BillID',
			as: 'QualityExecutive'
		});
		...
		modals.table_qual_executive_tasks.belongsTo(modals.table_users, {
			foreignKey: 'updated_by_user_id',
			as: 'Admin'
		});
